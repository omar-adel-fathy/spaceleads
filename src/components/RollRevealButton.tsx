  ...
  return (
    ...
    >
      ...
      <div className="relative w-full flex items-center justify-center h-full">
        ...
        <span className="absolute left-14 right-4 flex items-center text-[10px] font-black uppercase tracking-[0.15em] text-red-500 btn-roll-transition group-hover:-translate-y-12 group-hover:opacity-0">
          {defaultText}
        </span>

        {/* Hover text — slides up and fades in on hover */}
        <span className="absolute left-4 right-14 flex justify-end items-center translate-y-12 text-[10px] font-black uppercase tracking-[0.15em] text-red-500 opacity-0 btn-roll-transition group-hover:translate-y-0 group-hover:opacity-100">
          {hoverText}
        </span>
      </div>
    </button>
